...
public class IOS_AmazonPurchase {
	...
	// Connect to Android device using xCode
	public static void Purchase() throws Exception {
		...
		cap.setCapability("bundleId", "com.ca.projectpocket");
		...
		//IOS app path, we are developing(cannot connect to other IOS apps in App store)
        cap.setCapability("app", "/Users/ADMIN/Desktop/CAMobileApp.app");
